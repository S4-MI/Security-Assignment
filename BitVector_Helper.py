...
def matrix_mul(vector1, vector2):
    ...
    mix01 = BitVector(hexstring=vector1[1])
    st10 = BitVector(hexstring=vector2[1])
    b = st10.gf_multiply_modular(mix01, AES_modulus, 8)

    mix02 = BitVector(hexstring=vector1[2])
    st20 = BitVector(hexstring=vector2[2])
    c = st20.gf_multiply_modular(mix02, AES_modulus, 8)

    mix03 = BitVector(hexstring=vector1[3])
    st30 = BitVector(hexstring=vector2[3])
    d = st30.gf_multiply_modular(mix03, AES_modulus, 8)
